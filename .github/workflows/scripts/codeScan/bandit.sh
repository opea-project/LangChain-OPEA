...
source /LangChinaOPEA/.github/workflows/scripts/change_color
pip install --no-cache-dir bandit==1.7.8
log_dir=/LangChinaOPEA/.github/workflows/scripts/codeScan
python -m bandit -r -lll -iii /LangChinaOPEA > ${log_dir}/bandit.log
exit_code=$?
